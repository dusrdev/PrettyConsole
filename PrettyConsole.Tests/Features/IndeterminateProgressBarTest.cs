...
public sealed class IndeterminateProgressBarTest : IPrettyConsoleTest {
    ...
    public async ValueTask Implementation() {
        ...
        await prg.RunAsync(Task.Delay(5_000), (out value) => value = PrettyConsoleInterpolatedStringHandler.Build(OutputPipe.Error, $"...{ConsoleColor.Green}Running{ConsoleColor.DefaultForeground}..."), CancellationToken.None);
    }
}